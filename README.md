...
* There are not too many public datas related to demographic and social parameters for the city of Istanbul. Therefor you need create your own data tables. In this case, I collected latest House Price Averages for each Borough of Istanbul from housing retail web page [4].
